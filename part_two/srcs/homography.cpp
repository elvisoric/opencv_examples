...
// cv::Mat gray, blur, edge, thresh, dialatedImage;
// cv::cvtColor(frame, gray, cv::COLOR_BGR2GRAY);
// cv::imshow("gray", gray);
// cv::GaussianBlur(gray, blur, cv::Size(7, 7), 0.5);
// cv::imshow("blur", blur);
// cv::Canny(blur, edge, 0, 50, 3);
// cv::imshow("edge", edge);
//
...
// cv::dilate(thresh, dialatedImage, kernel);
// cv::imshow("dialatedImage", dialatedImage);
